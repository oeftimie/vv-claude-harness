...
Invocation: you run either as a plain subagent (the interactive flows above) or as a
workflow `agentType` agent; no messaging or task-management tools exist in either mode.
