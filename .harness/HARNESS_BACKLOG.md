...
| 2026-08-09 | Push guard blocked `git push origin v5.6.0` (a tag push) while checked out on main, and blocked a checkout-then-push compound the same way -- tag pushes are not main pushes; matcher keys on current branch + bare-push shape | revise (recognize refs/tags/ pushes as non-main-targeting) | v5.6.0 release phase, two blocks | 1 | candidate | 2026-08-09 |
